...
trait VideoTimingTestHelpers {
  ...
  protected def initTiming(dut: VideoTiming) = {
    dut.io.display.x.poke(320.U)
    dut.io.display.y.poke(240.U)
    dut.io.frontPorch.x.poke(36.U)
    dut.io.frontPorch.y.poke(12.U)
    dut.io.retrace.x.poke(20.U)
    dut.io.retrace.y.poke(2.U)
  }
}
